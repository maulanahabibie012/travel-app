    ...
    <div>
      ...
      <div className="container mx-auto px-4 py-8">
        <h1 className="text-3xl font-bold mb-2 text-center">
          Promo Liburan Untuk Kamu
        </h1>
        <p className="text-gray-600 text-sm text-center sm:text-base mb-16 leading-relaxed">
          Ingin bersantai di Bali yang eksotis atau menjelajahi destinasi luar
          negeri yang memukau?{" "}
          <span className="font-semibold text-fuchsia-600">Travel Bro!</span>{" "}
          hadir dengan berbagai{" "}
          <span className="font-semibold text-orange-500">
            promo liburan menarik
          </span>
          . untuk mewujudkan liburan impianmu! Dengan lebih dari
          <strong>100+ destinasi</strong> yang siap dieksplorasi, petualangan
          seru menantimu. 🌍✈️
        </p>
